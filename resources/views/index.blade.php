            ...
            @guest
                <div class="mt-16">
                    <div class="flex flex-col items-center">
                        {{-- 新規登録ボタン --}}
                        <a href="{{ route('register') }}" class="w-full scale-100 bg-white p-6 dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-md dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250">
                        ...
                        {{-- ログインボタン --}}
                        <a href="{{ route('login') }}" class="w-full mt-4 scale-100 bg-white p-6 dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-md dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250">
                            <div class="flex w-full items-center justify-center">
                                <h2 class="text-xl font-semibold text-gray-900 dark:text-white">ログイン</h2>
                            </div>
                        </a>
                        {{-- ゲストログインボタン --}}
                        <a href="{{ route('guest.register') }}" class="mt-10 w-full scale-100 p-6 bg-gray-800/50  rounded-lg shadow-md flex motion-safe:hover:scale-[1.01] transition-all duration-250">
                            <div class="flex w-full items-center justify-center">
